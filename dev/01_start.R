...
golem::fill_desc(
  ...
  author_email = "samuel.granjeaud@inserm.fr", # Your Email
  repo_url = "https://github.com/i-cyto/cytotransf", # The URL of the GitHub Repo (optional),
...
usethis::use_mit_license("Samuel Granjeaud") # You can set another license here
